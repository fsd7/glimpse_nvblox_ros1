...
void NvbloxNode::setupRosCommunication() {
  ...
  depth_sub1_.subscribe(nodeHandle_, depth_image_1_topic, 100);
  depth_camera_info_sub1_.subscribe(nodeHandle_, camera_info_1_topic, 100);
  ...
  color_sub1_.subscribe(nodeHandle_, rgb_image_1_topic, 100);
  color_camera_info_sub1_.subscribe(nodeHandle_, camera_info_1_depth_topic, 100);
